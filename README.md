# yolo_object_detection_system
Real-time object detection and dataset generation system using YOLOv8 and OpenCV.
In this project, objects are identified using a live-camera feed, classification logic is used to distinguish known and unknown.
...
# How to Run Code
- Install dependencies: pip install -r requisites.txt
